jQuery(function($) {
    ...
    $( '#menu-to-edit' ).on( 'sortstop', function() {
        $(this).find( '.menu-item' ).each( function() {
            var $image_select = $(this).find('.field-Quiety_Mega_Menu_image');
            var $image_position = $(this).find('.field-Quiety_Mega_Menu_bg_position');
            var $image_repeat = $(this).find('.field-Quiety_Mega_Menu_bg_repeat');
