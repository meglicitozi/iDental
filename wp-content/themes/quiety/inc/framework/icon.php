...
//
function quiety_codstar_fontawesomefive_icons($icons)
{

    // add FA 5.x icons
    $icons[] = array(
        'title' => __('Fontawesome Five (Free)', 'quiety'),
        'icons' => array(
            'fab fa-500px',
...
add_filter('csf_field_icon_add_icons', 'quiety_codstar_fontawesomefive_icons');